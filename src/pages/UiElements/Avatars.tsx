...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Ativiza - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Ativiza - React.js Tailwind CSS Admin Dashboard Template"
      />
