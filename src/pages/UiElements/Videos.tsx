...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Ativiza - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Ativiza - React.js Tailwind CSS Admin Dashboard Template"
      />
